...
import { generateInstructionsPDF } from "@/lib/instructionGenerator";
...
export default function MosaicCreator() {
  ...
  const handleDownloadInstructions = useCallback(() => {
    if (!result) return;
    const blob = generateInstructionsPDF(result);
    const url = URL.createObjectURL(blob);
    const a = document.createElement("a");
    a.href = url;
    a.download = `mosaic_${selectedSize.widthStuds}x${selectedSize.heightStuds}_instructions.pdf`;
    document.body.appendChild(a);
    a.click();
    document.body.removeChild(a);
    URL.revokeObjectURL(url);
              ...
              <div className="bg-slate-800/60 rounded-2xl p-5 border border-slate-700/50">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 text-sm mb-4">
                  ...
                  <div className="flex items-start gap-2.5">
                    ...
                    <p className="text-slate-300">
                      <span className="font-semibold text-white">Instructions PDF:</span>{" "}
                      Printable step-by-step building guide with numbered color grid
                    </p>
                  </div>
                </div>
                ...
                <div className="flex flex-wrap items-center gap-2">
                  <button
                    ...
                    className="px-4 py-2.5 bg-emerald-600 hover:bg-emerald-500 text-white font-semibold rounded-xl
                  ...
                  <button
                    ...
                    className="px-4 py-2.5 bg-amber-600 hover:bg-amber-500 text-white font-semibold rounded-xl
                  ...
                  <button
                    ...
                    className="px-4 py-2.5 bg-violet-600 hover:bg-violet-500 text-white font-semibold rounded-xl
